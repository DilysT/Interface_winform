    ...
    public partial class Signup: Form
    {
        ...
        private void button2_Click(object sender, EventArgs e) // tạo ô tick bằng thêm hiệu ứng chuyển cảnh
        {
            ...
            {//liên kết đến kho ảnh trong máy(cần phải tải về trước)
                Bitmap b = new Bitmap(@"C:\Users\PC\OneDrive - Trường ĐH CNTT - University of Information Technology\singup\o_tick.JPG");
                button2.Image = b; // gọi lại biến để xuất ảnh
            }
            else
            {
                Bitmap c = new Bitmap(@"C:\Users\PC\OneDrive - Trường ĐH CNTT - University of Information Technology\singup\o_empty.JPG");
                button2.Image = c;
            }
        }
